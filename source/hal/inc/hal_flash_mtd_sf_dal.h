...
int32_t SF_DAL_NonBlockEraseBlock(void);
int32_t SF_DAL_CheckDeviceReady(void *MTDData);
int32_t SF_DAL_CheckReadyAndResume(void *MTDData, uint32_t addr, uint8_t data);
int32_t SF_DAL_ResumeErase(void *MTDData);
int32_t SF_DAL_SuspendErase(void *MTDData);
