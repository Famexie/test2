...
App_ReConnection.c \
App_LinkKey.c \
App_Mcsync_Reconnection.c \
App_Mcsync_LinkKey.c \
...
C_SRC		+=	\
$(addprefix src/APP/APP_System/APP_InEarDetection/, \
App_InEarDetection.c \
)
...
C_SRC		+=	\
$(addprefix src/APP/APP_MCSync/, \
App_MCSync.c \
App_MCSyncKey.c \
App_MCSync_Message.c \
App_MCSync_RHO.c \
App_MCSync_State.c \
App_MCSync_System.c \
App_MCSync_Share.c \
App_MCSync_NvkeyHandler.c \
App_MCSync_Data.c \
)

C_SRC		+=	\
$(addprefix src/APP/APP_MCSyncRho/, \
App_RhoHandler.c \
App_RhoDominator.c \
App_MCSyncRho_NvkeyHandler.c \
)

C_SRC		+=	\
$(addprefix src/APP/APP_VpRtControl/, \
App_VpRtControl.c \
)
...
C_SRC		+=	\
$(addprefix src/APP/APP_System/APP_PressureSensor/, \
App_PressureSensor.c \
)
