...
#ifndef _APP_AWSMCEKEY_H_
#define _APP_AWSMCEKEY_H_
...
#endif
void APP_AWSMCE_KeyConnect(void);
void APP_AWSMCE_KeyDisConnect(BD_ADDR_T *pBdAddr);
void APP_AWSMCE_KeyEnableDiscoverable(void);
void APP_AWSMCE_KeyDisableDiscoverable(void);
