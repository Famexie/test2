...
enum
{
	...
	POWEROFF_REASON_TEMP_PROTECT, //5
	POWEROFF_REASON_AWS_IDLE,
	POWEROFF_REASON_AWS_RHO_FINISHED,
	POWEROFF_REASON_CHARGING_CASE,
	POWEROFF_REASON_SMARTCASE_POWEROFF, //9
	POWEROFF_REASON_SYNC,
	POWEROFF_REASON_XIAOAI,
};
...
typedef struct
{
	...
	BOOL powerOffAfterRHO;
	APP_POWER_OFF_REASON_STRU powerOff;
	U8 followerIFPKTRetryCount;
}APP_POWER_CTL_STRU;
